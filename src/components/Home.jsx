      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-0 h-full">
        ...
        <div className="bg-white-300 col-span-1 md:col-span-1 md:row-span-full flex items-center justify-center p-3">
          <div className="w-full md:-rotate- md:h-full text-center flex md:flex-col-reverse justify-between items-center">
            <img src={img} alt="logo" className="w-12 rounded-full md:-rotate-90" />
            <div className="[&>*]:px-2 text-2xl flex md:-rotate-90 md:mt-12">
              <a href="https://www.linkedin.com/in/azeem-khan62?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app">
                <i class="bi bi-github"></i>
              </a>
              <a href="https://github.com/MrAzeeeem23">
